# pUSD Value Proposition: The Firefly Network

> How independent journalism creates sustainable demand for Polkadot's stablecoin

---

## The Opportunity

**400-800 million monthly visits** across 100+ independent media outlets in Latin America, serving a population that cannot rely on traditional finance.

The Firefly Network transforms this audience into **active pUSD users** through a model that solves real problems for journalists, supporters, and diaspora communities.

### The Complete Stack: pUSD + Coinage
...
No "number go up" mentality. Just stable value moving through a functioning economy.

### Recurring Demand

- Monthly contributions to treasury
- Monthly journalist salaries
- Monthly membership fees
- Ongoing bounty creation and fulfillment
...
100 outlets × network effects = exponential pUSD adoption.

---

---

## Coinage: The Privacy Layer

For journalists in hostile environments, even censorship-resistant payments aren't enough. **They need privacy.**

### The Threat Model

```
Government surveillance → Identifies who funds independent media
On-chain tracing       → Targets journalists receiving payments
Transaction analysis   → Traces diaspora contributions to family
```

### How Coinage Solves This

Coinage is Polkadot's native private payment system:

- **Anonymous coin holding** — Balances not visible on-chain
- **Private transfers** — Sender/receiver identities hidden
- **Free for verified humans** — DIM credentials (already used by Firefly) enable free usage
- **pUSD denominated** — Same stable value, private transfer

### Privacy + pUSD = Complete Solution
...
Off-ramp to fiat               Diaspora contributions
Compliance flows               Source payments
```

### Why This Matters

**Scenario**: Venezuelan journalist receives $500 bounty payout for documenting corruption.

- **Without Coinage**: Government traces payment, journalist arrested
- **With Coinage**: No on-chain link between bounty and journalist

The Firefly Network becomes the first major use case for Coinage — proving that Polkadot's privacy technology protects real people doing important work.
...
1. **pUSD Asset ID** on Asset Hub for integration
2. **Coinage access** on People Chain when available
3. **Technical partnership** for implementation support
4. **On-ramp partnership** discussions (MoonPay, Transak, etc.)
5. **Ecosystem grant** consideration for development funding
...
[To be filled with appropriate contact information]

---

## Related Documents

- [pUSD Implementation Guide](/docs/pusd-integration-guide.md)
- [Coinage Integration Guide](/docs/coinage-integration-guide.md)
