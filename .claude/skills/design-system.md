...
<button className="border-accent text-accent hover:bg-accent hover:text-black">Illuminate</button>
```
...
<article className="bg-tertiary border-default rounded-lg border p-6">
  <div className="text-tertiary text-xs">Environmental · Concord, NH · 2h ago</div>
  <p className="text-primary mt-2 text-base">Chemical smell near the river...</p>
