/**
 * Seed Data — Mock data for development.
 *
 * This module contains all localized mock data and the seedAll function
 * that populates the seed store.
 *
 * Used by:
 * - seed-store.ts (auto-seed when NEXT_PUBLIC_SEED_DATA=true)
 * - scripts/seed-dev.ts (CLI command)
 */
  ...
  return [
    {
      ...
      en: {
        ...
        description: 'We need weekly documentation of basic food basket prices (canasta básica) from supermarkets and markets across different neighborhoods in Caracas.',
      ...
      es: {
        ...
        description: 'Necesitamos documentación semanal de los precios de la canasta básica en supermercados y mercados de diferentes barrios de Caracas.',
        topics: ['economy', 'food-security', 'inflation', 'documentation'],
        location: 'Caracas, Venezuela',
        status: 'open',
        fundingAmount: createPUSDAmount(450_000_000n),
    ...
    },
    {
      ...
      en: {
        ...
        description: 'Track and verify official appointments and dismissals in Venezuelan government ministries.',
        topics: ['politics', 'transparency', 'governance', 'public-records'],
        location: 'Venezuela',
        status: 'open',
      ...
      es: {
        ...
        description: 'Rastrear y verificar nombramientos y destituciones oficiales en los ministerios del gobierno venezolano.',
        topics: ['politics', 'transparency', 'governance', 'public-records'],
        location: 'Venezuela',
        status: 'open',
        fundingAmount: createPUSDAmount(600_000_000n),
    ...
    },
    {
      ...
      en: {
        ...
        title: 'Document hospital conditions in Maracaibo',
        description: 'We need firsthand documentation of conditions at public hospitals in Maracaibo.',
      ...
      es: {
        id: createBountyId('bounty-ve-003'),
        title: 'Documentar condiciones hospitalarias en Maracaibo',
        description: 'Necesitamos documentación de primera mano sobre las condiciones en hospitales públicos de Maracaibo.',
        topics: ['health', 'infrastructure', 'crisis', 'documentation'],
        location: 'Maracaibo, Venezuela',
        status: 'open',
        fundingAmount: createPUSDAmount(350_000_000n),
...
/**
 * Seed all mock data into the store.
...
export function seedAll(): void {
  ...
  // Seed collectives
  seedCollectives(createCollectiveData());
