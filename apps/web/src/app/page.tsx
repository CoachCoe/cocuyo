      ...
      <main className="pt-16">
        ...
        <section className="min-h-[90vh] flex items-center justify-center relative overflow-hidden">
          ...
          <div className="container-wide relative z-10 text-center py-20">
            ...
            {/* Pillars */}
            <div className="flex flex-wrap justify-center gap-4 text-sm text-[var(--color-text-secondary)] mb-12">
              <span className="px-4 py-2 border border-[var(--color-border-default)] rounded-full">
                Anonymous but Human
              </span>
              <span className="px-4 py-2 border border-[var(--color-border-default)] rounded-full">
        ...
        <section className="py-24 border-t border-[var(--color-border-default)]">
          <div className="container-narrow">
            ...
            <div className="space-y-6 text-[var(--color-text-secondary)] leading-relaxed">
              ...
              <p>
                The Firefly Network is <strong className="text-[var(--color-text-primary)]">not</strong> a social media
              ...
              <p>
                Here, you are not a user. You are a <strong className="text-[var(--color-text-primary)]">firefly</strong> —
        ...
        <section className="py-24 border-t border-[var(--color-border-default)] bg-[var(--color-bg-secondary)]">
          <div className="container-wide">
            ...
            <div className="grid md:grid-cols-3 gap-12">
              ...
              <div className="text-center">
                <div className="w-16 h-16 mx-auto mb-6 rounded-full bg-[var(--color-bg-tertiary)] border border-[var(--color-border-default)] flex items-center justify-center">
              ...
              <div className="text-center">
                <div className="w-16 h-16 mx-auto mb-6 rounded-full bg-[var(--color-bg-tertiary)] border border-[var(--color-border-default)] flex items-center justify-center">
                  <span className="text-2xl" style={{ color: 'var(--color-corroborated)' }}>
                    ◉
                  </span>
                </div>
              ...
              <div className="text-center">
                <div className="w-16 h-16 mx-auto mb-6 rounded-full bg-[var(--color-bg-tertiary)] border border-[var(--color-border-default)] flex items-center justify-center">
                  <span className="text-2xl text-[var(--color-text-primary)]">⟁</span>
                </div>
          ...
          <div className="container-narrow">
            ...
            <ul className="space-y-4 text-[var(--color-text-secondary)]">
              <li className="flex items-start gap-3">
                <span className="text-[var(--color-challenged)] mt-1">✕</span>
